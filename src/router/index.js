...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'stok-masuk', name: 'StokMasuk', component: () => import('@/views/stokMasuk/StokMasukList.vue') },
      { path: 'stok-masuk/create', name: 'StokMasukCreate', component: () => import('@/views/stokMasuk/StokMasukForm.vue') },
