...
import { getProduk, deleteProduk } from '@/api/produk'
import { getStokMasukByProduk } from '@/api/stokMasuk'
...
.btn-sm {
  ...
  border-radius: 6px; cursor: pointer; font-size: 12px; margin-right: 2px;
}
...
.modal .loading, .modal .empty { padding: 24px; }
</style>
