...
import { getDailyReport, getDailyProfit, getWeeklyReport, getMonthlyReport } from '@/api/report'
...
.period-tab {
  padding: 8px 16px; border: 2px solid #e0e0e0; background: #fff;
  border-radius: 8px; cursor: pointer; font-weight: 600; font-size: 13px; color: #666;
  transition: all 0.15s;
}
.period-tab.active {
  background: #e94560; color: #fff; border-color: #e94560;
}
.period-tab:hover:not(.active) { border-color: #ccc; }
...
.summary-value { font-size: 26px; font-weight: 700; color: #1a1a2e; }
.summary-value.primary { color: #e94560; }
</style>
