...
import { openShift, getShiftsByKasir } from '@/api/shift'
import { getTransaksiByKasir } from '@/api/transaksi'
...
.greeting { color: #666; margin-bottom: 24px; }
...
.shift-open { background: #e8f5e9; border-left: 4px solid #2e7d32; }
.shift-closed { background: #fff3e0; border-left: 4px solid #f57f17; }
.shift-icon i { font-size: 32px; }
.shift-open .shift-icon i { color: #2e7d32; }
.shift-closed .shift-icon i { color: #f57f17; }
.shift-body { flex: 1; display: flex; flex-direction: column; }
.shift-label { font-size: 12px; color: #888; text-transform: uppercase; letter-spacing: 1px; }
.shift-status { font-size: 14px; font-weight: 600; margin-top: 2px; }
.shift-open .shift-status { color: #2e7d32; }
.shift-closed .shift-status { color: #e65100; }
.btn-open {
...
.stat-icon { font-size: 32px; color: #2e7d32; }
.stat-body { display: flex; flex-direction: column; }
.stat-value { font-size: 22px; font-weight: 700; color: #1a1a2e; }
.stat-label { font-size: 13px; color: #888; }

.pos-action { text-align: center; margin-top: 8px; }
.btn-pos {
